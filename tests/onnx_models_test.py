...
def main(unused_argv):
  ...
  exclude_patterns.extend([
      # TPU failures
      "test_mask_r_cnn_r_50_fpn_tpu",
      "test_faster_r_cnn_r_50_fpn_qdq_tpu",
      "test_mask_r_cnn_r_50_fpn_fp32_tpu",
      "test_faster_r_cnn_r_50_fpn_int8_tpu",
      "test_fcn_resnet_50_int8_tpu",
      "test_mask_r_cnn_r_50_fpn_qdq_tpu",
      "test_bidaf_tpu",
      "test_caffenet_qdq_tpu",
      "test_alexnet_qdq_tpu",
      "test_faster_r_cnn_r_50_fpn_fp32_tpu",
      "test_densenet_121_12_int8_tpu",
      "test_efficientnet_lite4_int8_tpu",
      "test_faster_r_cnn_r_50_fpn_tpu",
      "test_fcn_resnet_101_tpu",
      "test_mask_r_cnn_r_50_fpn_int8_tpu",
      "test_efficientnet_lite4_qdq_tpu",
      "test_mosaic_tpu",
      "test_fcn_resnet_50_qdq_tpu",
      "test_lresnet100e_ir_tpu",
      "test_googlenet_qdq_tpu",
      "test_alexnet_int8_tpu",
      "test_caffenet_int8_tpu",
      "test_inception_1_int8_tpu",
      "test_bidaf_int8_tpu",
      "test_efficientnet_lite4_tpu",
      "test_inception_1_qdq_tpu",
      "test_bert_squad_int8_tpu",
      "test_lresnet100e_ir_int8_tpu",
      "test_candy_tpu",
      "test_googlenet_int8_tpu",
      "test_mnist_12_int8_tpu",
      "test_fcn_resnet_50_tpu",
      "test_roberta_sequenceclassification_tpu",
      "test_vgg_16_qdq_tpu",
      "test_pointilism_tpu",
      "test_resnet50_int8_tpu",
      "test_udnie_tpu",
      "test_zfnet_512_int8_tpu",
      "test_ssd_mobilenetv1_tpu",
      "test_roberta_base_tpu",
      "test_ssd_qdq_tpu",
      "test_yolov3_12_tpu",
      "test_yolov3_tpu",
      "test_shufflenet_v2_qdq_tpu",
      "test_ssd_int8_tpu",
      "test_vgg_16_int8_tpu",
      "test_yolov3_12_int8_tpu",
      "test_zfnet_512_qdq_tpu",
      "test_resnet_preproc_tpu",
      "test_ssd_mobilenetv1_12_tpu",
      "test_resnet50_qdq_tpu",
      "test_resnet101_duc_hdc_12_int8_tpu",
      "test_ssd_tpu",
      "test_shufflenet_v2_int8_tpu",
      "test_yolov4_tpu",
      "test_tiny_yolov3_tpu",
      "test_rain_princess_tpu",
      "test_ssd_mobilenetv1_12_int8_tpu",
      "test_ssd_mobilenetv1_12_qdq_tpu",
      # CPU failures
